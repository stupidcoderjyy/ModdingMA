...
public class Cube {
    ...
    JsonObject toJson() {
        ...
        elementObj.add("from", floatArrToJson(data.area, 0, 3));
        elementObj.add("to", floatArrToJson(data.area, 3, 6));
    ...
    public static JsonArray floatArrToJson(float[] arr, int begin, int end) {
