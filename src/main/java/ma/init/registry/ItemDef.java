...
public final class ItemDef<I extends Item> extends AbstractItemDef<I, ItemDef<I>> implements ITranslatable<ItemDef<I>> {
    ...
    public ItemDef<I> setName(String en_us, String zh_cn) {
        return genLanguage(this,"item", loc, en_us, zh_cn);
    }
